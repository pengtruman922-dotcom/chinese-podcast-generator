...
4. 少量mars系列音色，会有稳定性问题，如「磁性解说男生（jieshuonansheng）」；
...
|---|---|---|---|---|---|---|
| | | | | | | | \
|有声阅读 |儿童绘本  |zh_female_xueayi_saturn_bigtts |中文 | | |否 |
| | | | | | | | \
|通用场景  |vivi |zh_female_vv_uranus_bigtts |中文、英语 | | |否 |
| | | | | | | | \
|视频配音 |大壹 |zh_male_dayi_saturn_bigtts |中文 | | |否 |
| | | | | | | | \
|视频配音 |黑猫侦探社咪仔 |zh_female_mizai_saturn_bigtts |中文 | | |否 |
| | | | | | | | \
|视频配音 |鸡汤女 |zh_female_jitangnv_saturn_bigtts |中文 | | |否 |
| | | | | | | | \
|视频配音 |魅力女友 |zh_female_meilinvyou_saturn_bigtts |中文 | | |否 |
| | | | | | | | \
|视频配音 |流畅女声 |zh_female_santongyongns_saturn_bigtts |中文 | | |否 |
| | | | | | | | \
|视频配音 |儒雅逸辰 |zh_male_ruyayichen_saturn_bigtts |中文 | | |否 |
| | | | | | | | \
|通用场景 |小何 |zh_female_xiaohe_uranus_bigtts |中文 | | |否 |
| | | | | | | | \
|通用场景 |云舟 |zh_male_m191_uranus_bigtts |中文 | | |否 |
| | | | | | | | \
|通用场景 |小天 |zh_male_taocheng_uranus_bigtts |中文 | | |否 |
| | | | | | | | \
|角色扮演 |可爱女生 |saturn_zh_female_keainvsheng_tob |中文 | | |否 |
| | | | | | | | \
